        ...
        if ($heslo !== $heslo_potvrd) {
            ...
            try {
                ...
                if ($user_id) {
                    ...
                    header("Location: dashboard.php?toast=welcome");
                    exit;
                }
...
<body>
    ...
    <main class="auth-form-container">
        ...
        <div id="verify-form-wrapper" class="<?php echo ($action != 'verify') ? 'hidden-form' : ''; ?>">
            <form method="POST" action="" class="auth-form">
                <p style="color: white; margin-bottom: 20px;">
                    Zadejte 5místný kód, který Vám přišel na e-mail:
                    **<?php echo htmlspecialchars($email_for_verification); ?>**
                </p>

                <div class="verification-input-container">
                    <input type="number" class="verification-input" maxlength="1" min="0" id="c1" required>
                    <input type="number" class="verification-input" maxlength="1" min="0" id="c2" required>
                    <input type="number" class="verification-input" maxlength="1" min="0" id="c3" required>
                    <input type="number" class="verification-input" maxlength="1" min="0" id="c4" required>
                    <input type="number" class="verification-input" maxlength="1" min="0" id="c5" required>

                    <input type="hidden" name="verification_code" id="final_code">

                    <input type="hidden" name="email_hidden"
                        value="<?php echo htmlspecialchars($email_for_verification); ?>">
                </div>
                ...
                <button type="submit" id="resend-code-button" class="auth-button"
                    style="background-color: #555; display: none;" name="resend_code_action" value="1" disabled
                    formnovalidate>
                    Poslat kód znovu
                </button>
            </form>
        ...
        <p style="margin-top: 40px; font-size: 0.75rem; opacity: 0.4;">
            <a href="privacy.php" style="color: white; text-decoration: none;">Podmínky používání & Ochrana soukromí</a>
        </p>
